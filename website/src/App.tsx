        ...
        <nav style={S.sidebar} className={`mobile-sidebar${menuOpen ? " open" : ""}`}>
          <div style={S.sidebarInner}>
            ...
            <div style={S.navSection}>
              ...
              <a href="https://github.com/AndrewAntoshkin/spektr" target="_blank" rel="noopener" style={S.navIcon}><svg viewBox="0 0 80 19" height="16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M35.93 7.23c-.08-.3-.2-.55-.36-.78a2.38 2.38 0 0 0-.56-.58 2.4 2.4 0 0 0-.75-.37 3.3 3.3 0 0 0-.93-.13c-.63 0-1.19.16-1.67.47-.47.31-.85.77-1.11 1.37-.27.6-.4 1.33-.4 2.19 0 .86.13 1.6.39 2.2.26.6.63 1.07 1.11 1.38.48.32 1.05.47 1.7.47.59 0 1.1-.1 1.52-.32.42-.21.74-.51.96-.9.23-.39.34-.84.34-1.37l.53.08h-3.19V8.98h5.18v1.56c0 1.09-.23 2.02-.69 2.8-.46.78-1.09 1.38-1.9 1.77-.81.42-1.73.63-2.77.63-1.16 0-2.18-.26-3.06-.77a5.36 5.36 0 0 1-2.06-2.19c-.49-.95-.73-2.08-.73-3.38 0-1 .15-1.9.44-2.68.29-.79.7-1.46 1.23-2.01a5.2 5.2 0 0 1 1.84-1.25 5.7 5.7 0 0 1 2.28-.43c.7 0 1.35.1 1.96.31.6.2 1.14.49 1.6.86.47.37.86.81 1.15 1.32.3.51.49 1.07.58 1.68h-2.66Zm4.68 8.38V6.32h2.58v9.29h-2.58Zm1.29-10.48a1.3 1.3 0 0 1-.99-.38 1.26 1.26 0 0 1-.39-.93c0-.35.13-.66.4-.91.27-.26.6-.39.99-.39.38 0 .71.13.98.39.27.25.41.56.41.91 0 .36-.14.67-.41.93-.27.25-.6.38-.99.38Zm7.69 1.19v1.93h-5.59V6.32h5.59Zm-4.32-2.22h2.58v8.66c0 .24.04.42.11.56.07.13.17.22.3.27.13.05.29.08.46.08.12 0 .24-.01.36-.03.12-.02.21-.04.28-.05l.4 1.92c-.13.04-.31.09-.55.14-.23.06-.52.09-.85.1-.62.02-1.17-.07-1.63-.25-.47-.19-.83-.49-1.09-.89-.26-.4-.38-.9-.38-1.51V4.09Zm8.18 6.15v5.37h-2.58V3.22h2.5v4.73h.11c.21-.55.55-.98 1.02-1.29.47-.31 1.05-.47 1.76-.47.64 0 1.21.14 1.69.42.48.28.86.68 1.12 1.2.27.52.41 1.14.4 1.87v5.91h-2.58v-5.45c0-.57-.15-1.02-.44-1.34-.29-.32-.7-.48-1.22-.48-.35 0-.66.07-.93.22-.27.15-.48.37-.63.65-.15.28-.23.63-.23 1.02Zm13.41 1.41V6.32h2.58v9.29h-2.47v-1.69h-.1a2.76 2.76 0 0 1-1.04 1.31c-.48.33-1.07.5-1.77.5-.62 0-1.17-.14-1.64-.42a2.93 2.93 0 0 1-1.11-1.2c-.26-.52-.39-1.14-.4-1.87V6.32h2.58v5.45c0 .55.15.98.44 1.3.29.32.68.48 1.17.48.31 0 .6-.07.87-.21.27-.15.49-.36.65-.64.17-.28.25-.63.25-1.05Zm4.09 3.95V3.22h2.58v4.66h.08c.11-.25.28-.5.49-.76.22-.26.5-.48.85-.65.35-.18.78-.27 1.3-.27.68 0 1.3.18 1.87.53.57.35 1.03.88 1.37 1.59.34.71.51 1.59.51 2.65 0 1.04-.17 1.91-.5 2.62-.33.71-.78 1.25-1.35 1.62-.57.36-1.2.55-1.91.55-.5 0-.92-.08-1.28-.25a2.52 2.52 0 0 1-.85-.62 4.04 4.04 0 0 1-.51-.77h-.12v1.49h-2.54Zm2.53-4.64c0 .55.08 1.03.23 1.44.15.41.37.73.66.96.29.23.65.34 1.06.34.42 0 .77-.11 1.06-.34.29-.23.52-.56.67-.97.15-.41.23-.89.23-1.43 0-.54-.08-1.01-.23-1.41-.15-.41-.37-.73-.66-.96-.29-.23-.65-.35-1.07-.35-.42 0-.77.11-1.06.33-.28.22-.5.54-.66.95-.15.41-.23.89-.23 1.44Z" fill="white"/><path d="M9.6 0a9.6 9.6 0 0 1 7.8 15.21 9.6 9.6 0 0 1-4.74 3.5c-.48.1-.66-.2-.66-.46 0-.32.01-1.36.01-2.64 0-.9-.3-1.48-.65-1.78 2.14-.24 4.38-1.06 4.38-4.74 0-1.06-.37-1.91-.99-2.58.1-.24.43-1.23-.1-2.55 0 0-.8-.27-2.64.97a9.14 9.14 0 0 0-4.8 0C5.39 3.72 4.59 3.97 4.59 3.97c-.53 1.32-.2 2.3-.1 2.55a3.71 3.71 0 0 0-.99 2.58c0 3.67 2.23 4.5 4.37 4.74-.28.24-.53.66-.61 1.28-.56.25-1.94.66-2.8-.79-.18-.29-.72-1-.48-1 .81.01 1.29.56 1.3.56.4.23.87 1.08.98 1.36.19.54.82 1.57 3.23 1.13 0 .8.01 1.56.01 1.79 0 .25-.18.56-.67.46A9.6 9.6 0 0 1 9.6 0Z" fill="white"/></svg></a>
              <a href="https://www.npmjs.com/package/@andrewaitken/spektr" target="_blank" rel="noopener" style={S.navIcon}><svg viewBox="0 0 52 20" height="16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M51.43 17.14H25.71V20H14.29v-2.86H0V0h51.43v17.14ZM17.14 2.86v14.29h5.71v0h.01v-2.86h5.71V2.86H17.14ZM2.86 2.86v11.43h5.71V5.71h2.86v8.57h2.86V2.86H2.86Zm28.57 0v11.43h5.71V5.71h2.86v8.57h2.86V5.71h2.86v8.57h2.86V2.86H31.43ZM25.71 5.71v5.72h-2.86V5.71h2.86Z" fill="white"/></svg></a>
            </div>
          </div>
...
const S: Record<string, React.CSSProperties> = {
  ...
  navIcon: { display: "block", padding: "5px 8px", borderRadius: 6, marginLeft: -8, opacity: 0.55, textDecoration: "none" },
